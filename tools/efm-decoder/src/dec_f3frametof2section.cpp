...
F3FrameToF2Section::State F3FrameToF2Section::expecting_sync0()
{
    ...
    case F3Frame::SYNC1:
        missed_sync0s++;
        if (show_debug)
            qDebug() << "F3FrameToF2Section::expecting_sync0 - Sync1 frame received when expecting "
                        "Sync0";
    ...
    case F3Frame::SUBCODE:
        ...
        if (show_debug)
            qDebug() << "F3FrameToF2Section::expecting_sync0 - Subcode frame received when "
                        "expecting Sync0";
...
F3FrameToF2Section::State F3FrameToF2Section::expecting_sync1()
{
    ...
    case F3Frame::SYNC0:
        ...
        if (show_debug)
            qDebug() << "F3FrameToF2Section::expecting_sync1 - Sync0 frame received when expecting "
                        "Sync1";
    ...
    case F3Frame::SUBCODE:
        ...
        if (show_debug)
            qDebug() << "F3FrameToF2Section::expecting_sync1 - Subcode frame received when "
                        "expecting Sync1";
...
F3FrameToF2Section::State F3FrameToF2Section::expecting_subcode()
{
    ...
    case F3Frame::SYNC0:
        missed_subcodes++;
        if (show_debug)
            qDebug() << "F3FrameToF2Section::expecting_subcode - Sync0 frame received when "
                        "expecting Subcode";
    ...
    case F3Frame::SYNC1:
        missed_subcodes++;
        if (show_debug)
            qDebug() << "F3FrameToF2Section::expecting_subcode - Sync1 frame received when "
                        "expecting Subcode";
...
F3FrameToF2Section::State F3FrameToF2Section::process_section()
{
    ...
    if (section_buffer.first().get_f3_frame_type() != F3Frame::SYNC0) {
        qFatal("F3FrameToF2Section::process_section - First frame in section buffer is not a "
               "Sync0");
    }

    // Sanity check - Is the second frame a sync1?
    if (section_buffer.at(1).get_f3_frame_type() != F3Frame::SYNC1) {
        qFatal("F3FrameToF2Section::process_section - Second frame in section buffer is not a "
               "Sync1");
    }
    ...
    for (int i = 2; i < 98; i++) {
        if (section_buffer.at(i).get_f3_frame_type() != F3Frame::SUBCODE) {
            qFatal("F3FrameToF2Section::process_section - Frame %d in section buffer is not a "
                   "Subcode",
                   i);
        }
    }
